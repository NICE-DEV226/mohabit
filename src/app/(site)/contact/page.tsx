      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-2 space-y-6">
            <Button href={waLink('Bonjour Modu Habitat, je souhaite un devis.')} external variant="secondary" size="lg" className="w-full justify-center bg-green-600 hover:bg-green-700">
            ...
            <div className="bg-grey-dark rounded-xl p-6 space-y-4">
              <ContactInfo icon="location" label="Adresse" value="Ouagadougou, Burkina Faso" href="https://maps.app.goo.gl/BAueDd7b5wVGiBLf6" />
              <ContactInfo icon="phone" label="Téléphone" value="+226 XX XX XX XX" />
              <ContactInfo icon="email" label="Email" value="contact@moduhabitat.com" />
            </div>
            ...
            <div className="rounded-xl overflow-hidden h-48 sm:h-56 bg-grey-mid">
              <iframe
                src="https://www.google.com/maps?q=Ouagadougou+Burkina+Faso&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Modu Habitat - Ouagadougou"
              />
            </div>
          </div>
        </div>
